          ...
          <div className="max-w-4xl mx-auto">
            ...
            <ul className="grid sm:grid-cols-2 gap-4 md:gap-6">
              {goals.map((goal, index) => (
                <ScrollReveal key={goal.title} direction="up" delay={100 + index * 50}>
                  <li className="flex items-start gap-3 p-4 rounded-lg bg-white border border-slate-200/60 hover:shadow-md transition-shadow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {coreValues.map((value, index) => (
                <ScrollReveal key={value.title} direction="up" delay={100 + index * 50}>
                  <div className="p-5 rounded-lg bg-slate-50/50 border border-slate-200/60 hover:shadow-md transition-shadow">
